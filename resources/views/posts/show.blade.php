...
@section('content')
    ...
    <article class="blog-spot mt-5">
        <h2 class="blog-post-title mb-4 text-center">{{ $data->title }}
        </h2>
        <p class="text-center">
            <small>
        ...
        <p class="blog-post-meta">Created At : {{ date('d M Y', strtotime($data->created_at)) }}
        </p>
    </article>
    ...
    <div class="container">
        @foreach ($comments->take(1) as $comment)
            <div class="my-1">
                ...
                <blockquote class="blockquote mb-0">
                    ...
                    <p class="blockquote-footer mb-2">
                        <small>
        ...
        @if ($comments->count() > 1)
            <div class="position-relative my-4">
                <a class="posisition-absolute top-50 start-50 translate-middle" id="showAllComments">
                    Show All Comments
                </a>
            </div>
