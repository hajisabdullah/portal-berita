        ...
        <div class="carousel-inner">
            @foreach ($post as $p)
                <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                    <img src="{{ asset('storage/' . $p->image) }}" class="d-block w-100 rounded-2 opacity-50" style="object-fit: cover; height:400px;"
                        alt="Slide Image">
                    <div class="carousel-caption d-none d-md-block text-dark">
                        <h3>{{ $p->title }}</h3>
                        <a href="{{ route('landingShow', $p->slug) }}" class="text-dark">
